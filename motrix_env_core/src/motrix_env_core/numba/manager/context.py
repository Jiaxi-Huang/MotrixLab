...
if TYPE_CHECKING:
    ...
    from motrix_env_core.sim import SimModel
...
class BuildContext:
    ...
    compiled model (including ``bodies``), and the already-created
    action/command term registries. Terms must not reach past
