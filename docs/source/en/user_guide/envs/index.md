...
| <img src="../../_static/images/poster/go1-walk-stairs.jpg" alt="go1-walk-stairs" width="240"> | `go1-walk-stairs` | Track walking commands with Unitree Go1 over procedural stairs surrounded by flat ground. | `motrix.fastsac`, `rslrl.ppo`, `skrl.ppo` |
...
| <img src="../../_static/images/poster/go2-walk-stairs.jpg" alt="go2-walk-stairs" width="240"> | `go2-walk-stairs` | Track walking commands with Unitree Go2 over procedural stairs surrounded by flat ground. | `motrix.fastsac`, `rslrl.ppo`, `skrl.ppo` |
